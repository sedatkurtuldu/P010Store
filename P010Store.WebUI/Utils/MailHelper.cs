...
namespace P010Store.WebUI.Utils
{
	public class MailHelper
	{
		...
		{
			SmtpClient smtpClient = new SmtpClient("mail.siteadresi.com",587); //1. parametre mailin gönderileceği sunucu adresi. 2. paramtere mail sunucu port numarası.
			smtpClient.Credentials = new NetworkCredential("email kullanıcı adı(info@siteadi.com)","email şifre");
			smtpClient.EnableSsl = true; // eğer mail sunucusu ssl sertifikası kullanıyorsa, aktif et.
			MailMessage message = new MailMessage();
			message.From = new MailAddress("info@siteadi.com"); // maili gönderen adres.
			message.To.Add("mailingonderileceğiadres@gmail.com"); // mailin gönderileceği adres.
			message.To.Add("mailingonderileceğiadres2@gmail.com"); // mailin gönderileceği adres 2
